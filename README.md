...
*Note that the Open-Fortress-Content-Source and Open-Fortress-Source folders are NOT required to launch the game, but they are required if you want to recompile from source or make modifications to the content.*
...
### IMPORTANT FOR MODIFYING THE 2020 VERSION OF THE GAME
...
```
You can technically pull any commit from the repo, but this is the closest one that matches the build of the game.
